...
// import { withMobileDialogVisual } from './withMobileDialogVisual';
// import { withWidthVisual } from './withWidthVisual';
...
export const ExpansionPanel = 'ExpansionPanel';
export const ExpansionPanelActions = 'ExpansionPanelActions';
export const ExpansionPanelDetails = 'ExpansionPanelDetails';
export const ExpansionPanelSummary = 'ExpansionPanelSummary';
export const Fade = 'Fade';
export const FilledInput = 'FilledInput';
export const FormControl = 'FormControl';
export const FormControlLabel = 'FormControlLabel';
export const FormGroup = 'FormGroup';
export const FormHelperText = 'FormHelperText';
export const FormLabel = 'FormLabel';
export const Grid = 'Grid';
export const GridList = 'GridList';
export const GridListTile = 'GridListTile';
export const GridListTileBar = 'GridListTileBar';
...
export const ListItemSecondaryAction = 'ListItemSecondaryAction';
export const ListItemText = 'ListItemText';
export const ListSubheader = 'ListSubheader';
export const Logo = 'Logo';
export const Menu = 'Menu';
export const MenuItem = 'MenuItem';
export const MenuList = 'MenuList';
export const MobileStepper = 'MobileStepper';
export const Modal = 'Modal';
export const ModalManager = 'ModalManager';
export const NativeSelect = 'NativeSelect';
export const NoSsr = 'NoSsr';
...
export const RootRef = 'RootRef';
export const Select = 'Select';
export const Slide = 'Slide';
export const Snackbar = 'Snackbar';
export const SnackbarContent = 'SnackbarContent';
export const Step = 'Step';
export const StepButton = 'StepButton';
export const StepConnector = 'StepConnector';
export const StepContent = 'StepContent';
export const StepIcon = 'StepIcon';
export const StepLabel = 'StepLabel';
export const Stepper = 'Stepper';
export const SvgIcon = 'SvgIcon';
export const SwipeableDrawer = 'SwipeableDrawer';
...
export const TableSortLabel = 'TableSortLabel';
export const Tabs = 'Tabs';
export const TextField = 'TextField';
export const Toolbar = 'Toolbar';
export const Tooltip = 'Tooltip';
export const Typography = 'Typography';
// export const withMobileDialog = 'withMobileDialog';
...
export interface Visual {
    ...
    // ButtonBase: { type: typeof ButtonBase; };
    Card: CardVisual & {
        type: typeof Card;
    };
    ...
    InputAdornment: InputAdornmentVisual & {
        type: typeof InputAdornment;
    };
    InputBase: InputBaseVisual & {
        type: typeof InputBase;
    };
    InputLabel: InputLabelVisual & {
        type: typeof InputLabel;
    };
    LinearProgress: LinearProgressVisual & {
        type: typeof LinearProgress;
    };
    List: ListVisual & {
        type: typeof List;
    };
    ...
    MobileStepper: MobileStepperVisual & {
        type: typeof MobileStepper;
    };
    Modal: ModalVisual & {
        type: typeof Modal;
    };
    ModalManager: ModalManagerVisual & {
        type: typeof ModalManager;
    };
    NativeSelect: NativeSelectVisual & {
        type: typeof NativeSelect;
    };
    NoSsr: NoSsrVisual & {
        type: typeof NoSsr;
    };
    OutlinedInput: OutlinedInputVisual & {
        type: typeof OutlinedInput;
    };
    Paper: PaperVisual & {
        type: typeof Paper;
    };
    ...
    StepConnector: StepConnectorVisual & {
        type: typeof StepConnector;
    };
    StepContent: StepContentVisual & {
        type: typeof StepContent;
    };
    StepIcon: StepIconVisual & {
        type: typeof StepIcon;
    };
    StepLabel: StepLabelVisual & {
        type: typeof StepLabel;
    };
    ...
    // withMobileDialog: { type: typeof withMobileDialog; };
    // withWidth: { type: typeof withWidth; };
    Zoom: ZoomVisual & {
        type: typeof Zoom;
    };
}
