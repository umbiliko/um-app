...
export const actions = {
    ...
    setIn: (keyPath: KeyArray, value: any): ImmutableAction[typeof SET_IN] => ({ keyPath, type: SET_IN, value }),
    update: (key: string, value: any): ImmutableAction[typeof UPDATE] => ({ key, type: UPDATE, value }),
    updateIn: (keyPath: KeyArray, value: any): ImmutableAction[typeof UPDATE_IN] => ({ keyPath, type: UPDATE_IN, value }),
};
